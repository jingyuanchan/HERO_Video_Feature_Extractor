...
from dataflow import MultiProcessMapDataZMQ, MultiThreadMapData
...
def parse_args():
    ...
    parser.add_argument(
        '--target_framerate', type=int, default=24,
...
def main():
    ...
    if args.dataflow:
        ...
        loader = MultiProcessMapDataZMQ(
            ...
            map_func=readvideo, strict=True, buffer_size=1000)
        loader.reset_state()
